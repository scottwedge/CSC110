...
var m=1,G=2,Z=4
var M="[object Arguments]",E="[object Array]",F="[object Boolean]",S="[object Date]",I="[object Error]",z="[object Function]",C="[object GeneratorFunction]",T="[object Map]",W="[object Number]",k="[object Object]",D="[object RegExp]",P="[object Set]",Q="[object String]",R="[object Symbol]",L="[object WeakMap]"
...
var $={}
$[M]=$[E]=$[N]=$[q]=$[F]=$[S]=$[H]=$[U]=$[V]=$[X]=$[J]=$[T]=$[W]=$[k]=$[D]=$[P]=$[Q]=$[R]=$[K]=$[B]=$[Y]=$[_]=true
$[I]=$[z]=$[L]=false
function rr(r,t,n,E,F,S){var I,T=t&m,W=t&G,D=t&Z
n&&(I=F?n(r,E,F,S):n(r))
if(void 0!==I)return I
if(!g(r))return r
var P=w(r)
if(P){I=j(r)
if(!T)return f(r,I)}else{var Q=b(r),R=Q==z||Q==C
if(h(r))return i(r,T)
if(Q==k||Q==M||R&&!F){I=W||R?{}:y(r)
if(!T)return W?s(r,a(I,r)):v(r,c(I,r))}else{if(!$[Q])return F?r:{}
I=x(r,Q,T)}}S||(S=new e)
var L=S.get(r)
if(L)return L
S.set(r,I)
d(r)?r.forEach((function(e){I.add(rr(e,t,n,e,r,S))})):O(r)&&r.forEach((function(e,o){I.set(o,rr(e,t,n,o,r,S))}))
var N=D?W?p:l:W?keysIn:A
var q=P?void 0:N(r)
o(q||r,(function(e,o){if(q){o=e
e=r[o]}u(I,o,rr(e,t,n,o,r,S))}))
...
//# sourceMappingURL=85-c-dd9d4b2102.js.map